...
package STEP1_2_3_4_PBPK.Utils {
  ...
  Encoders_Intrinsic *-- waspEncoder : encoder
  ...
  Dense_Encoders *-- waspDenseEncoder : encoder
  ...
  Dense_Encoders_Intrinsic *-- waspDenseEncoder : encoder
  ...
  DecodersIntegralWarper2 *-- waspWarper : warper
  DecodersIntegralWarper2 *-- waspGridSpatialIntegral : integrator
  ...
  DecodersIntegralWarper2_Intrinsic *-- waspWarper : warper
  DecodersIntegralWarper2_Intrinsic *-- waspGridSpatialIntegral : integrator
  ...
  Dense_DecodersIntegralWarper2 *-- waspWarper : warper
  Dense_DecodersIntegralWarper2 *-- waspGridSpatialIntegral : integrator
  ...
  Dense_DecodersIntegralWarper2_Intrinsic *-- waspWarper : warper
  Dense_DecodersIntegralWarper2_Intrinsic *-- waspGridSpatialIntegral : integrator
...
package STEP1_2_3_PBPK.TrainFunction {
...
package "STEP1_2_PBPK.TrainFunction" {
